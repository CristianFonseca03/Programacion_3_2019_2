...
<%
    ...
    int empresa_id = Integer.parseInt(request.getParameter("id_empresa"));
    String empresa_name = "";
...
<html lang="en">
    ...
    <body>
        <div class="container">
            ...
            <h1 class="mt-5">Editar empresa <span class='badge badge-primary mr-2'>
                    <%
                        out.print(empresa_name);
                    %>
                </span></h1> 
            <div class="form-group mt-5">
                <form name="form" action="editEmpresaResult.jsp" class="border p-3 form" method="GET" onsubmit="return validateForm()">
                    <input type="number" class="form-control d-none" name="id" value="<% out.print(empresa_id); %>">
                    <label for="nombre">Nombre</label>
                    <input type="text" class="form-control" name="nombre" value="<% out.print(empresa_name);%>" required>
