        ...
        <div class="container">
            ...
            <div class="mt-5">
                <div class="d-flex justify-content-center align-items-center">
                    <h1>Lugares</h1> 
                    <a class="btn btn-outline-success ml-4" href="createLugar.jsp" role="button"><i class="fas fa-plus"></i></a>
                </div>
                    ...
                    <tbody>
                        <%
                            for (int i = 0; i < lugares.size(); i++) {
                                ...
                                String url_parameters = "?id_lugar="+lugares.get(i).getID();
                                out.print("<td><a class='btn btn-outline-warning' href='editLugar.jsp"+url_parameters+"' role='button'><i class='fas fa-pen'></i></a><a class='btn btn-outline-danger' href='deleteLugarResult.jsp"+url_parameters+"' role='button'><i class='fas fa-minus-circle'></i></a></td>");
                                out.print("</tr>");
                            }
                        %>
                    </tbody>
