...
<%
    int empresa = Integer.parseInt(request.getParameter("id_empresa"));
    Logic lg = new Logic();
    boolean result = lg.deleteEmpresa(empresa);
%>
        ...
        <div class="container">
            ...
            <%                
                if (result){
                    ...
                    out.print("<h1>Empresa eliminada con exito</h1>");
                    out.print("</div>");
                } else {
                    out.print("<div class='alert alert-danger mt-5' role='alert'>");
                    out.print("<h1>Error al eliminar</h1>");
                    out.print("</div>");
                }
            %>
